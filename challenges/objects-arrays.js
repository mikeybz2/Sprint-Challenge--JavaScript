...
const tyrannosaurus ={ name: 'tyrannosaurus', diet: 'carnivorous', weight: '700kg', length: '12m', period: 'Late Cretaceous', roar: function(dinoSound){
...
const velociraptor ={ name: 'velociraptor', diet: 'carnivorous', weight: '215kg', length: '1.8m', period: 'Late Cretaceous'}
